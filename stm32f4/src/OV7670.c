...
/**
  ...
  */
uint8_t OV7670_DCMI_SingleRandomRead(uint8_t Device, uint16_t Addr)
{
...
/**
  ...
  * @retval None
  */
uint8_t OV7670_DCMI_SingleRandomWrite(uint8_t Device, uint16_t Addr, uint8_t Data)
{
	I2C_Delay();
...
int OV7670_init(void){
	...
	for(i=0; i<OV7670_REG_NUM ;i++){
        ...
        err = OV7670_DCMI_SingleRandomWrite(OV7670_WRITE_ADDR, OV7670_reg[i][0], data);
        
		if (err == 1)
			break;
			
		TM_ILI9341_DrawLine(99+i, 110, 99+i, 130, ILI9341_COLOR_WHITE);
        /*
        TM_ILI9341_Puts(0, 60, itoa(err, str, 16), &TM_Font_11x18, ILI9341_COLOR_BLACK, ILI9341_COLOR_BLUE2);
        TM_ILI9341_Puts(0, 80, "i now: ", &TM_Font_11x18, ILI9341_COLOR_BLACK, ILI9341_COLOR_BLUE2);
        TM_ILI9341_Puts(0, 100, "  ", &TM_Font_11x18, ILI9341_COLOR_BLACK, ILI9341_COLOR_BLUE2);
        TM_ILI9341_Puts(0, 100, itoa(i, str, 10), &TM_Font_11x18, ILI9341_COLOR_BLACK, ILI9341_COLOR_BLUE2);
        */
		_delay_ms(100);
	}
    // Init DCMA + DMA
